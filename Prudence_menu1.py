        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    order_list.append({
                        # Access the correct item name from the dictionary
                        "Item name": item_name["Item name"],  
                         # Access the correct price from the dictionary
                    ...
                    print("I am sorry, but what you entered is not valid")
                    
        
                # Tell the customer they didn't select a menu option
            else:
                print("Error: You did not select a menu option.")
        else:
            # Tell the customer they didn't select a menu option
...
for item in order_list:
    ...
    f"{item_name}{name_spaces}{price}{price_spaces}{quantity}{quantity_spaces}"
